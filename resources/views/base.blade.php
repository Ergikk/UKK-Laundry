  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        <div class="sidebar-brand-text mx-3">Laundry GEN11</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseMenu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('/paket/home', []) }}">Home</a>
            <a class="collapse-item" href="{{ url('/paket/new', []) }}">Baru</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseMeja" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Halaman:</h6>
            <a class="collapse-item" href="{{ url('/mesin/home', []) }}">Home</a>
            <a class="collapse-item" href="{{ url('/mesin/new', []) }}">Baru</a>
          </div>
        </div>
      </li>
