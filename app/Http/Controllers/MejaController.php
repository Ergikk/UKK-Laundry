...
class MejaController extends Controller
{
    ...
    public function validateNew(Request $request)
    {
        ...
        $this->new($request);
        return redirect('/mesin/home')->with('meja_success', 'Berhasil Menambah Mesin!');
    }
    ...
    public function validateEdit(Request $request, $id)
    {
        ...
        return redirect('/mesin/home')->with('meja_success', 'Berhasil Mengubah Data Mesin!');
    }
    ...
    public function validateDelete(Request $request)
    {
        ...
        $this->delete($request);
        return redirect('/mesin/home')->with('meja_success', 'Berhasil Menghapus Mesin!');
    }
