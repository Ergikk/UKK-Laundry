...
class MenuController extends Controller
{
    ...
    public function validateNew(Request $request)
    {
        ...
        $this->new($request);
        return redirect('/paket/home')->with('menu_success', 'Berhasil menambah Paket!');
    }
    ...
    public function validateEdit(Request $request, $id)
    {
        ...
        return redirect('/paket/home')->with('menu_success', 'Berhasil mengubah data Paket!');
    }
    ...
    public function validateDelete(Request $request)
    {
        ...
        $this->delete($request);
        return redirect()->back()->with('menu_success', 'Berhasil menghapus Paket!');
    }
